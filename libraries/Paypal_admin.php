 ...
 *
 * Library for PayPal payment gateway. It helps to integrate payment payment gateway
 * in CodeIgniter application.
 *
 * It also requires PayPal configuration file and it should be placed in the config directory.
 *
 * @package     CodeIgniter
 * @category    Libraries
 * @author      CodexWorld
...
class Paypal_admin
{
	...
	function __construct(){
		...
		$this->CI->load->config('paypaladmin');
