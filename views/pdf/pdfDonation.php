...
<html>
    ...
    <title>Donation Data Download</title>
            ...
            <section class="panel">
                <table border="1" id="myTableUser" class="table table-hover">
                    <tbody>
                        ...
                        <?php $i=1;if(count($donation) > 0){ foreach($donation as $val){ ?>
                                <tr style="margin-bottom: 20px;">
                                    ...
                                    <td><?php if($val['giftAid']){ ?><a href="<?= site_url('admin/save_gift_aid/')."/".$val['id']; ?>"><?php echo (number_format((float)($val['amount'] * 0.25), 2, '.', '')); ?></a><?php }else{echo 0;} ?></td>
                                </tr>
                            <?php $i++; }} ?>
                            <tr>
                                <td colspan="9" style="text-align: center;">
                                    <strong><?= "Total Donation In ".date('Y')." : (£) ". $totalAmount[0]['total'] ?></strong>
                                </td>
                            </tr>
                    </tbody>
                </table>
