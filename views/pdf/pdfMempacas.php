                    ...
                    <thead>
                                                    ...
                                                    <?php $i=1; if(isset($mempacas['membersId'])){ foreach($members as $val1){ ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="vertical-align: text-top;"><?= ucfirst($membersDetail[0]['fname']." ".$membersDetail[0]['lname']); ?></td>
                                                            <td style="vertical-align: text-top;"><?= $membersDetail[0]['mobileNo'] ?></td>
                                                            <td style="vertical-align: text-top;"><?php if(empty($mempacasGroupMember[0]['lastContactDate'])){ echo 'Not Yet Contacted'; }else{ echo date('d-m-Y', strtotime($mempacasGroupMember[0]['lastContactDate'])); } ?></td>
                                                            <td style="vertical-align: text-top;" width="40%"><?php if(empty($mempacasGroupMember[0]['memberResponse'])){ echo 'No Response'; }else{ echo ucfirst($mempacasGroupMember[0]['memberResponse']); } ?></td>
                                                            <td style="vertical-align: text-top;"><?php if(empty($mempacasGroupMember[0]['specialPrayerRequest'])){ echo 'No Prayer Requested'; }else{ echo ucfirst($mempacasGroupMember[0]['specialPrayerRequest']); } ?></td>
                                                            <td style="vertical-align: text-top;" width="25%"><?php if(empty($mempacasGroupMember[0]['comment'])){ echo 'No Comment'; }else{ echo ucfirst($mempacasGroupMember[0]['comment']); } ?></td>
                                                            <td style="vertical-align: text-top;"><?php if(empty($mempacasGroupMember[0]['seniorPastorToFollowUp']) || $mempacasGroupMember[0]['seniorPastorToFollowUp'] == 0){ echo 'No'; }else{ echo 'Yes'; } ?></td>
                                                        </tr>
                                                        <?php $i++; }}else{ ?>
                                                        <tr>
