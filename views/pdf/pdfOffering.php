...
<html>
    ...
    <title>Offerings Data Download</title>
                ...
                <table border="1" id="myTableUser" class="table table-hover">
                    <tbody>
                        <tr>
                            <th>S.No.</th>
                            <th>Date Posted</th>
                            <th>Date of Offering</th>
                            <th>Admin Name</th>
                            <th>Amount (£)</th>
                        </tr>
                        <?php $i=1;if(count($offerings) > 0){ foreach($offerings as $val){ ?>
                                <tr>
                                    <td><?= $i ?></td>
                            ...
                            <tr>
                                <td colspan="9" style="text-align: center;">
                                    <strong><?= "Total Offerings In ".date('Y')." : (£) ". number_format(($totalAmount[0]['total']),2,'.', ','); ?></strong>
                                </td>
                            </tr>
                    </tbody>
                </table>
