...
<html>
    ...
    <title>Gift Aid Government Claim</title>
    ...
    <div class="row">
        ...
        <div class="invoice_header md-bg-blue-grey-500">
            <h2 style="text-align: center">
                <img class="uk-float-left" src="https://demo.mmsonline.website/assets_new/assets/img/logo_main.png" alt="" width="100">
                Government Claims
            </h2>
        </div>
        ...
        <div class="uk-margin-medium-bottom">
            <span class="uk-text-muted uk-text-small uk-text-italic">Date:</span> <span><?= date('d-M-Y', strtotime($val['date']));?></span>
            <br>
        </div>
        <div class="uk-margin-medium-bottom">
            <div class="" style="float: right">
                <span class="uk-text-muted uk-text-small uk-text-italic">From:</span><br/>
                <span><strong><?= $details[0]['name']?></strong></span><br/>
            ...
            <div class="uk-width-small-6-10 uk-row-first">
                ...
                <span class="uk-text-muted uk-text-small uk-text-italic">To:</span>
                    <address>
                        <p><strong>UK Income Tax Department</strong></p>
                        <p>London</p>
                        <p></p>
                    </address>
                    <span class="uk-text-muted uk-text-small uk-text-italic">Total:</span>
                <p class="heading_b uk-text-success">£ <?= $val['amount'] * 0.25; ?></p>
                </div>
            </div>
            <div class="uk-margin-medium-bottom">
            <div class="uk-width-1-1">
                <table class="uk-table">
                    ...
                    <tr class="uk-text-upper">
                        ...
                        <th>Name</th>
                        <th>Purpose</th>
                        <th class="uk-text-center">Amount Total</th>
                        <th class="uk-text-center">Claimable Amount</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr class="uk-table-middle">
                        ...
                        <td>
                            <span class="uk-text-large"><?= $this->data->fetch('member', array('id' => $val['user_id']))[0]['fname']." ".$this->data->fetch('member', array('id' => $val['user_id']))[0]['lname'];?></span><br>
                            <!--<span class="uk-text-muted uk-text-small">Testing</span>-->
                        </td>
