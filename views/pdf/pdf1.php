...
<div class="container">
    ...
    <div class="row">
                <div class="table-responsive">
                        <table id="myTableUser" class="table table-hover" border="1">
                            <thead>
                            <tr>
                                <th style="width: 10%;">Name</th>
                                <th style="width: 10%;">Total Login</th>
                                <th style="width: 10%;">Profile Picture</th>
                                <th style="width: 10%;">Gender</th>
                                <th style="width: 10%;">Age</th>
                                <th style="width: 10%;">Marital Status</th>
                                <th style="width: 10%;">Job Status</th>
                                <th style="width: 10%;">Native Country</th>
                                ...
                                <th style="width: 10%;">Total Donations</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php $i=1; foreach($memberData as $val){ ?>
                                <tr align = "center">
                                    <td align="center"><?= ucfirst($val['fname'])." ".ucfirst($val['lname']) ?></td>
                                    ...
                                    <td align="center"><?= ucfirst($val['gander']); ?></td>
                                    <td align="center" style="display : none;"><?= $val['age_group'] ?></td>
                                    <td align="center" style="display : none;"><?= $val['maritalStatus'] ?></td>
                                    <td align="center" style="display : none;"><?= $val['employement'] ?></td>
                                    <td align="center" style="display : none;"><?= $val['nativeCountry'] ?></td>
                                    <td align="center" style="display : none;"><?= $val['hobbies']; ?></td>
                                    <td align="center" style="display : none;"><?= $val['poatalCode'] ?></td>
                                    <td align="center"><?= ucfirst($val['businessGroup']) ?></td>
                                    <td align="center"><?= $val['nativeCountry'] ?></td>
