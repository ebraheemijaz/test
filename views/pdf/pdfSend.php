...
<div class="container">
    <div class="row">
        ...
        <div class="uk-margin-medium-bottom">
            ...
            $expiry = $val['expiry'];
            $expiryDate = date('d-M-Y', strtotime($Date. ' + '.$expiry.' days'));
            ?>
            <span class="uk-text-muted uk-text-small uk-text-italic">Due Date:</span> <span><?= $expiryDate; ?></span>
            <br>
        </div>
        <div class="uk-width-small-6-10 uk-row-first">
            <div class="uk-margin-medium-bottom" style="float: right">
                ...
                <span><strong><?= $this->data->fetch('member', array('id' => $val['user_id']))[0]['fname']." ".$this->data->fetch('member', array('id' => $val['user_id']))[0]['lname'];?></strong></span>
            </div>
        </div>
            <div class="uk-width-small-6-10 uk-row-first">
                ...
                <span class="uk-text-muted uk-text-small uk-text-italic"><?= ucfirst($_GET['type']) ?> To:</span>
                    <address>
                        <p><strong><?= $val['client_data'][0]['fname']." ".$val['client_data'][0]['lname']; ?></strong></p>
                    </address>
