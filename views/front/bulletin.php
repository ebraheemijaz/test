                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <?php foreach($bulletin as $val){ ?>
                            <div class="col-xs-12">
                                <div class="col-xs-4">
                                    <a href="<?= site_url('home/view/read_bulletin/'.$val['id']) ?>">
                                ...
                                <div class="col-xs-8">
                                    ...
                                    <a style="color:black" href="<?= site_url('home/view/read_bulletin/'.$val['id']) ?>">
                                        <h1><?= ucfirst($val['title']); ?></h1>
                                    </a>
                                    <p>
                                        <?= strip_tags(substr($val['text'],0,450)); ?>
                                        <a href="<?= site_url('home/view/read_bulletin/'.$val['id']) ?>">
                                            ...
                                        </a>
                                    </p>
