    ...
    <div class="col-md-6">
        <div class="radios">
            <label class="label_radio col-lg-6 col-sm-6" for="radio-01">
                <input  name="gander" id="radio-01" value="male" type="radio" checked /> Male
            </label>
            <label class="label_radio col-lg-6 col-sm-6" for="radio-02">
                <input name="gander" id="radio-02" value="female" type="radio" /> Female
            </label>
        </div>
    </div>
    <div class="row"></div>
    ...
    <div class="row"></div>
    <div class="col-md-6">
        <textarea name="career" id="" cols="30" rows="3" placeholder="Briefly tell us what you do" class="form-control"></textarea>
    </div>
    <div class="col-md-6">
        <textarea name="biography" id="" cols="30" rows="3" placeholder="How many years experience do you have?" class="form-control"></textarea>
    </div>
    <div class="row"></div>
    <br/>
    ...
    <div class="col-md-6">
        <input type="text" class="form-control" required name="address" placeholder="Address: Line 1">
    </div>
    <div class="col-md-6">
    ...
    <div class="row"></div>
    <div class="col-md-6">
        <input type="text" class="form-control" id="parenmobile" name="mobileNo" placeholder="Enter country code then mobile e.g 447912444553">
    </div>
    <div class="col-md-6">
        <input type="text" class="form-control" name="homeNo" placeholder="Home #">
    </div>
    <div class="col-md-1">
        <p>Profile Pic</p>
    </div>
    ...
    <div class="col-md-6">
        <input type="text" class="form-control" name="email" id="parenEmail" required placeholder="Email *">
    </div>
    <div class="row"></div>
    <div class="col-md-6">
        <input type="password" required class="form-control" onkeyup="checkPasswd()" id="password1" placeholder="Enter Password *">
    </div>
    <div class="col-md-6">
        <input type="password" class="form-control" required onkeyup="checkPasswd()" id="password2" name="password" placeholder="Enter Password Again *">
    </div>
    ...
    <div class="col-lg-offset-4 col-lg-4 col-md-12">
        <button class="btn btn-lg btn-login btn-block" id="doreg" disabled type="submit">Create</button>
    </div>
    <div class="row"></div>
