...
<div id="page_content">
    ...
    <div id="page_content_inner">
        <h4 class="heading_a uk-margin-bottom">Edit Advert</h4>
        <div class="uk-grid uk-grid-medium" data-uk-grid-margin data-uk-grid-match="{target:'.md-card'}">
            <?= form_open_multipart('home/updateAdvert/'.$data[0]['id'].'/advert/advert',array("class"=>"form-signin","autocomplete"=>"off","style"=>"max-width: 100% !important;")) ?>
