                                ...
                                <div class="user_heading_avatar fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                            <img src="<?= $image ?>" alt="" class="detect8"/>
                                            <?php
                                            }else{
                                            ?>
                                            <img src="<?= $image ?>" alt=""/>
                                        ...
                                        <div class="uk-margin-top">
                                            ...
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-2">
                                                    ...
                                                    <input class="md-input" value="<?= $v['fname']." ".$v['lname']?>" readonly type="text" id="user_edit_uname_control"/>
                                                </div>
                                                <div class="uk-width-medium-1-2">
<!--                                                    <label for="user_edit_uname_control">Sex</label>-->
                                                    <select id="select_demo_4" class="md-input" name="gander">
                                                        <!--<option selected value='<?= $v['gander'] ?>'><?= $v['gander'] ?></option>-->
                                            ...
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-1">
                                                    <label for="user_edit_uname_control">Hobbies</label>
                                                    <input class="md-input" type="text" name="hobbies" value="<?= $v['hobbies'] ?>"/>
                                                </div>
                                            </div>
                                            <div class="uk-grid" data-uk-grid-margin>
                                            ...
                                            <div class="uk-grid" data-uk-grid-margin>
                                                ...
                                                <div class="uk-width-medium-1-3">
                                                    ...
                                                    <select id="select_demo_4"  class="md-input" name="age_group">
                                                        ...
                                                        <option <?= ($v['age_group'] == "50")? "selected" : ""; ?> value="50"> Above 50 </option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="uk-grid" data-uk-grid-margin>
                                            ...
                                            <div class="uk-form-row">
                                                <span>Member of Church Since</span>
                                                <div class="uk-grid" data-uk-grid-margin>
                                                    <div class="uk-width-medium-1-2">
                                            ...
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-2">
                                                    <label for="user_edit_uname_control">Address Line 1</label>
                                                    <input class="md-input" type="text" name="address" value="<?= $v['address'] ?>"/>
                                                </div>
                                                <div class="uk-width-medium-1-2">
                                                ...
                                                <div class="uk-width-medium-1-3">
                                                    <label for="user_edit_uname_control">Town</label>
                                                    <input class="md-input" type="text" name="town" value="<?= $v['town'] ?>"/>
                                                </div>
                                                <div class="uk-width-medium-1-3">
                                                    <label for="user_edit_uname_control">Post Code</label>
                                                    <input class="md-input" type="text" name="poatalCode" value="<?= $v['poatalCode'] ?>"/>
                                                </div>
                                                <div class="uk-width-medium-1-2">
                                            ...
                                            <div class="uk-grid" data-uk-grid-margin>
                                                ...
                                                <div class="uk-width-medium-1-2">
                                                    <select name="employement" id="employ" class="md-input">
                                            ...
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-2">
                                                    <select name="maritalStatus" id="marital" class="md-input">
                                            ...
                                            <div class="uk-grid">
                                                <div class="uk-width-1-1">
                                                    <label for="user_edit_personal_info_control">About Me</label>
                                                    <textarea class="md-input" name="biography" cols="30" rows="4"><?= $v['biography'] ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="uk-margin-top">
                                            ...
                                            <?php for($i=0;$i<5;$i++){ ?>
                                                <div class="uk-grid" data-uk-grid-margin>
                                                    <div class="uk-width-medium-1-2">
                                                        <select id="select_demo_4_<?= $i ?>" class="md-input" name="groups[<?= $i ?>]">
                                    ...
                                    <!--<li>-->
                                        <!--<a href="#addGroupp" data-uk-modal><span class="md-btn md-btn-primary">Add Group</span></a>-->
                                    <!--    <div class="uk-margin-top">-->
                                    <!--        <?php for($i=0;$i<3;$i++){ ?>-->
                                    <!--            <div class="uk-grid" data-uk-grid-margin>-->
                                    <!--                <div class="uk-width-medium-1-2">-->
...
<script>
    ...
    //         return true;
    //     }else{
    //         alert('Values are same for two church group.');
    //         return false;
    //     }
    // });
</script>
