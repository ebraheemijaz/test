...
<div id="page_content">
    <div id="page_content_inner">
        <h3 class="heading_b uk-margin-bottom">Keepers' Network </h3>
                    ...
                    <div  class="md-card-content" data-step="1" data-intro="List of all the testimony comes here">
                        ...
                        <table id="dt_default" class="uk-table" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <th data-step="3" data-intro="Absentee Name">Absentee Name</th>
                                <th data-step="4">Absence Description</th>
                                <th data-step="5">Absentee Contact No</th>
                                <th data-step="6">Absentee Email</th>
                                <th data-step="7">Date Last Seen(If Known)</th>
                                <th data-step="8">Comment(Optional)</th>
                            ...
                            <?php if(!empty($keepersNetwork)){ ?>
                                <?php $i=1; foreach($keepersNetwork as $val){ ?>
                                        <tr>
                                            ...
                                            <td><?php if($val['absenceDescription'] == 'other'){echo $val['absenceDescriptionOther']; }else{echo $val['absenceDescription']; }; ?></td>
                                            <td><?= $val['absenteeContactNo']; ?></td>
                                            <td><?= $val['absenteeEmail']; ?></td>
                                            <td><?= date('d-m-Y', strtotime($val['dateLastSeen'])); ?></td>
                                            <td><? if(isset($val['comment']) && $val['comment'] != null){ echo $val['comment']; }else{ echo "No comment Present."; }?></td>
                                            <td><a style="cursor: pointer" onclick="deleteC('<?= site_url('home/deleteKN') . "/" . $val['keeperId']."/same" ?>')">Delete</a></td>
                                        </tr>
                                    <?php $i++; } ?>
                            <?php } ?>
                            </tbody>
