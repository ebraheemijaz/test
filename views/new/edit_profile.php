<?php
$v1 = $userAdmin[0];
$members = $this->data->fetch('member', array('id' => $v1['id'], 'status' => 'active'));
$v = $members[0];
// print_r($v);
?>
<style>
                        ...
                        <div class="md-card">
                            ...
                            <div class="user_content">
                                <ul id="user_edit_tabs" class="uk-tab" data-uk-tab="{connect:'#user_edit_tabs_content'}">
                                    <li class="uk-active"><a href="#">Personal Details</a></li>
...
<!--                                                    <label for="user_edit_uname_control">Sex</label>-->
                                            ...
                                            <div class="uk-grid" data-uk-grid-margin>
                                                ...
                                                <div class="uk-width-medium-1-2" id="oGroupDiv" style="display: none;">
                                                    <label for="user_edit_uname_control">Group Name <span style="color: red;">*</span></label>
                                                    <input class="md-input" type="text" name="oGroup" id="oGroup" value="<?= $v['oGroup'] ?>"/>
                                                </div>
                                                <div class="uk-width-medium-1-2">
                                        ...
                                        <div class="uk-margin-top">
                                            ...
                                            <?php for($i=0;$i<5;$i++){ ?>
                                                <div class="uk-grid" data-uk-grid-margin>
                                                    ...
                                                    <!--<div class="uk-width-medium-1-2" id="oCGroupDiv_<?= $i ?>" style="display: block;">-->
                                                    <!--    <label for="user_edit_uname_control">Church Group Name <span style="color: red;">*</span></label>-->
                                                    <!--    <input class="md-input" type="text" name="oCGroup[<?= $i ?>]" id="oCGroup_<?= $i ?>" value="<?= $v['oGroup'] ?>"/>-->
                                                    <!--</div>-->
                                                </div>
                                            <?php } ?>
                                        ...
                                        <div class="uk-margin-top">
                                            ...
                                            <br/>
                                                <?php $ci = 0; ?>
                                                <?php $child = $this->data->fetch('children', array('parent_id' => $v['id'], 'relation' => 'child')); ?>
                                                <?php foreach($child as $ch){ ?>
                                                        <div class="uk-grid" data-uk-grid-margin>
                                                            <div class="uk-width-medium-1-2">
                                                                <label for="user_edit_uname_control">First Name</label><br/>
                                                                <input class="md-input" type="text"  id="user_edit_uname_control1" name="child[<?= $ci ?>][<?= 'fname' ?>]" value="<?= $ch['fname'] ?>"/>
                                                            </div>
                                                            <div class="uk-width-medium-1-2">
                                                                <label for="user_edit_uname_control">Last Name</label><br/>
                                                                <input class="md-input" type="text"  id="user_edit_uname_control1" name="child[<?= $ci ?>][<?= 'lname' ?>]" value="<?= $ch['lname'] ?>"/>
                                                            </div>

                                                            <div class="uk-width-medium-1-2">
                                                                <label for="user_edit_uname_control">Month Of Birth</label><br/>
                                                            ...
                                                            <div class="uk-width-medium-1-2">
                                                                <label for="user_edit_uname_control">Day Of Birth</label><br/>
                                                            ...
                                                            <div class="uk-width-medium-1-2">
                                                                <label for="user_edit_age_group">Age Group</label><br/>
                                                                <select id="select_demo_4"  class="md-input" name="child[<?= $ci; ?>][<?= 'age_group'?>]">
                                                                    <option value="">Select Age Group</option>
                                                                    <?php if($v['age_group'] >= 18){ ?><option <?= ($ch['age_group'] == "9")? "selected" : ""; ?> value="9"> 0 - 9 </option><?php } ?>
                                                                    <?php if($v['age_group'] >= 29){ ?><option <?= ($ch['age_group'] == "12")? "selected" : ""; ?> value="12"> 10 - 12 </option><?php } ?>
                                                                    <?php if($v['age_group'] >= 39){ ?><option <?= ($ch['age_group'] == "18")? "selected" : ""; ?> value="18"> 13 - 18 </option><?php } ?>
                                                                    <?php if($v['age_group'] >= 49){ ?><option <?= ($ch['age_group'] == "29")? "selected" : ""; ?> value="29"> 19 - 29 </option><?php } ?>
                                                                    <?php if($v['age_group'] >= 70){ ?><option <?= ($ch['age_group'] == "39")? "selected" : ""; ?> value="39"> 30 - 39 </option><?php } ?>
                                                                    <?php if($v['age_group'] >= 70){ ?><option <?= ($ch['age_group'] == "40")? "selected" : ""; ?> value="49"> 40 - 49 </option><?php } ?>
                                                                    <?php if($v['age_group'] >= 70){ ?><option <?= ($ch['age_group'] == "69")? "selected" : ""; ?> value="69"> 50 - 69 </option><?php } ?>
                                                                </select>
                                                            </div>
                                                            <div class="uk-width-medium-1-2">
                                                                <label for="user_edit_uname_control">Gender</label><br/>
                                                            ...
                                                            <div class="uk-width-medium-1-2">
                                                                ...
                                                                <label for='user_edit_uname_control'>Child Email</label><br/>
                                                                <p><input <?php if(!empty($ch['email'])){ echo 'checked'; } ?> type='checkbox'>Enter Child Email or tick box to enter your own</p>
                                                                <input class="md-input" type="email"  id="user_edit_uname_control" name="child[<?= $ci ?>][<?= 'email' ?>]" value="<?= $ch['email'] ?>"/>
                                                            </div>
                                                            <div class="uk-width-medium-1-2">
                                                                <label for='user_edit_uname_control'>Child Mobile</label><br/>
                                                                <p><input <?php if(!empty($ch['mobile'])){ echo 'checked'; } ?> type='checkbox'>Enter Child Mobile or tick box to enter your own</p>
                                            ...
                                            <span class="md-btn md-btn-danger" onclick="addChild()">Add More +</span>
                                        </div>
                                        ...
                                        <div class="uk-margin-top">
                                            ...
                                            <?php $ci = 0; ?>
                                            <?php $grandChild = $this->data->fetch('children', array('parent_id' => $v['id'], 'relation' => 'grand')); ?>
                                            <?php foreach($grandChild as $ch){ ?>
                                                <div class="uk-grid" data-uk-grid-margin>
                                                    <div class="uk-width-medium-1-2">
                                                        <label for="user_edit_uname_control">First Name</label><br/>
                                                    ...
                                                    <div class="uk-width-medium-1-2">
                                                        <label for="user_edit_age_group_control">Age Group</label><br/>
                                                    ...
                                                    <div class="uk-width-medium-1-2">
                                                        <label for='user_edit_uname_control'>Grand Child Email</label><br/>
                                                        <p><input <?php if(!empty($ch['email'])){ echo 'checked'; } ?> type='checkbox'>Enter Grand Child Email or tick box to enter your own</p>
                                                        <input class="md-input" type="email"  id="user_edit_uname_control" name="grandChild[<?= $ci ?>][<?= 'email' ?>]" value="<?= $ch['email'] ?>"/>
                                                    </div>
                                                    <div class="uk-width-medium-1-2">
                                                        <label for='user_edit_uname_control'>Grand Child Mobile</label><br/>
                                                        <p><input <?php if(!empty($ch['mobile'])){ echo 'checked'; } ?> type='checkbox'>Enter Grand Child Mobile or tick box to enter your own</p>
                                            ...
                                            <?php if($v['age_group'] >= 39){ ?><span class="md-btn md-btn-danger" onclick="addgrandChild()">Add More +</span><?php } ?>
                                        </div>
                                    </li>
                                </ul>
...
<script>
    ...
    function addgrandChild(){
        ...
        var gchild = "<div id='grandChildField"+gci+"' style='padding: 15px 15px;border:1px #e8e8e8 solid'>" +
            ...
            "<select class='md-input' onchange='gchildDay("+gci+")' required id='gchildm"+gci+"' name='grandChild["+gci+"][month]'> ";
            gchild += "<option value=''>Select</option>"+
            ...
            "<select class='md-input' id='gchildd"+gci+"' required name='grandChild["+gci+"][day]'> ";
            gchild += "<option value=''>Select</option>";
            for(var i = 1; i<=31;i++){
    ...
    function addChild(){
        ...
        var child = "<div id='ChildField"+ci+"' style='padding: 15px 15px;border:1px #e8e8e8 solid'> " +
            ...
            "<div class='uk-width-medium-1-2'>" +
            "<label for='user_edit_uname_control'>Birth Month</label> " +
            "<select class='md-input' onchange='childDay("+ci+")' required id='childm"+ci+"' name='child["+ci+"][month]'> ";
        child += "<option value=''>Select</option>" +
        "<option value='1'>January</option> " +
        "<option value='2'>February</option> " +
        "<option value='3'>March</option> " +
        "<option value='4'>April</option> " +
        ...
        "<div class='uk-width-medium-1-2'>" +
        "<label for='user_edit_uname_control'>Birth Day</label> " +
        "<select class='md-input' id='childd"+ci+"' required name='child["+ci+"][day]'> ";
        child += "<option value=''>Select</option>";
        for(var i = 1; i<=31;i++){
    ...
    $('#select_demo_4_0').on('change', function(){
        var groupId = $(this).val();
        if(groupId == 0){
            $('#oCGroupDiv_0').css('display', 'block');
            $('#oCGroup_0').attr('required', true);
        }else{
            $('#oCGroupDiv_0').css('display', 'none');
            $('#oCGroup_0').attr('required', false);
        }
    });
    $('#select_demo_4_1').on('change', function(){
        var groupId = $(this).val();
        if(groupId == 0){
            $('#oCGroupDiv_1').css('display', 'block');
            $('#oCGroup_1').attr('required', true);
        }else{
            $('#oCGroupDiv_1').css('display', 'none');
            $('#oCGroup_1').attr('required', false);
        }
    });
    $('#select_demo_4_2').on('change', function(){
        var groupId = $(this).val();
        if(groupId == 0){
            $('#oCGroupDiv_2').css('display', 'block');
            $('#oCGroup_2').attr('required', true);
        }else{
            $('#oCGroupDiv_2').css('display', 'none');
            $('#oCGroup_2').attr('required', false);
        }
    });
    $('#select_demo_4_3').on('change', function(){
        var groupId = $(this).val();
        if(groupId == 0){
            $('#oCGroupDiv_3').css('display', 'block');
            $('#oCGroup_3').attr('required', true);
        }else{
            $('#oCGroupDiv_3').css('display', 'none');
            $('#oCGroup_3').attr('required', false);
        }
    });
    $('#select_demo_4_4').on('change', function(){
        var groupId = $(this).val();
        if(groupId == 0){
            $('#oCGroupDiv_4').css('display', 'block');
            $('#oCGroup_4').attr('required', true);
        }else{
            $('#oCGroupDiv_4').css('display', 'none');
            $('#oCGroup_4').attr('required', false);
        }
    });
...
$('#bgroup').on('change', function(){
    var groupId = $(this).val();
    if(groupId == 0){
        $('#oGroupDiv').css('display', 'block');
        $('#oGroup').attr('required', true);
    }else{
        $('#oGroupDiv').css('display', 'none');
        $('#oGroup').attr('required', false);
    }
});
