...
<body>
	...
	<div class="agileits_top_menu" style="background: rgba(67,215,136,0.77);">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-2" id="link-effect-2">
							<ul class="nav navbar-nav navbar-right">
								<li class="active"><a href="<?= $_SERVER['HTTP_REFERER'] ?>" class="effect-3 scroll">Home</a></li>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<ol class="carousel-indicators">
		    <?php $banner = explode(',', $business[0]['banner']); ?>
		...
		<div class="carousel-inner" role="listbox">
			...
			<div class="item <?php if($i == 0){ ?>active<?php } ?> img-responsive" style="background: -webkit-linear-gradient(rgba(23, 22, 23, 0.2), rgba(23, 22, 23, 0.5)), url(<?= base_url('assets_f/banners/'.$bannerImg[$i]['img']) ?>) no-repeat;">
				<div class="container">
		...
		<ul class="portfolio_agile_info_w3ls">
			...
			<li>
				<div class="agile_events_top_grid">	
					...
					<div class="agileits_w3layouts_events_text port_info_agile" style="background: rgba(67,215,136,0.77);">
						<h6><?= $pr['desc'] ?></h6>
					</div>
				</div>
			</li>
...
<div class="footer-bot wow fadeInRight animated" data-wow-delay=".5s" style="background: rgba(67,215,136,0.77);">
	<div class="container">
			<div class="logo2">
