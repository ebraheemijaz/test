<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row">
            ...
            <a href="<?php echo base_url(); ?>admin/save_suspend_pdf" title="Download Suspended Members Data"><i class="md-icon material-icons">get_app</i></a>
        </span></header>
                    ...
                    <div class="panel-body">
                        ...
                        <table id="myTableUser" class="table table-hover">
                            ...
                            <tbody>
                            <?php $i=1; foreach($memberSus as $val){ ?>
                                <tr>
                                    ...
                                    <td><a onclick="statusChange('<?= site_url("admin/statusMember/".$val['id']."/".$status) ?>')"><?php if($val['status'] == 'active'){ echo 'Active'; }else{ echo 'Suspended'; }?></a></td>
...
<script>
    ...
    function statusChange(link){
        ...
        var a = "<div class='modal fade' id='deleteConf' role='dialog' tabindex='-1' aria-labelledby='mySmallModalLabel'> " +
            ...
            "</button> " +
            "<h4 style='text-align: center;font-weight: bold;' class='modal-title' id='mySmallModalLabel'> " +
            "Are You Sure you want to make this member active again? " +
            "</h4> " +
            "</div> " +
            "<div class='modal-body'> " +
