...
<?php $id = $this->uri->segment(4); $data = $this->data->fetch('HOD', array('id' => $id)) ?>
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">Edit H.O.D.</header>
                    <div class="panel-body">
                        <?= form_open_multipart('admin/update/'.$data[0]['id'].'/HOD/viewHOD',array("id" => "attendanceForm", "class"=>"form-signin","autocomplete"=>"off","style"=>"max-width: 100% !important;")) ?>
                        <div class="login-wrap">
                            <div class="col-md-12">
                                ...
                                <select name="member" required class="form-control chosen-select teachInCharge" placeholder="Select Member" id="teacher">
                                    ...
                                    <?php foreach($generalIn as $val){ ?>
                                        <option <?php if($data[0]['memberId'] == $val['id']){ echo 'selected'; } ?> value="<?= $val['id'] ?>"><?= $val['fname'] ?> <?= $val['lname'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="row"></div>
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="departmentName" id="departmentName" value="<?= $data[0]['departmentName'] ?>" required="required" placeholder="Enter Department Name" autofocus>
                            </div>
                            <br/>
                            <div class="row"></div>
                            <div class="col-md-12">
                                <strong>Department Position</strong><span style="color: red;">*</span><br/>
                                <input type="text" class="form-control" name="departmentPosition" id="departmentPosition" value="<?= $data[0]['departmentPosition'] ?>" required="required" placeholder="Enter Department Position" autofocus>
                            </div>
                            <br/>
                            <div class="row"></div>
                            <br/>
