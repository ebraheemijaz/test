            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <?= form_open_multipart('admin/sendEmail/member',array("class"=>"form-horizontal", "id" => "my-form")) ?>
                            <?php
                            ...
                            <div class="form-group">
                                <div class="col-md-10 col-md-offset-2 ">
                                    <button class="btn btn-success" onclick="validateCount()" id = "send_email_button" >Send</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    function validateCount()
    {
        ...
        email_msg = $('.trumbowyg-editor')
        if (email_msg){
            email_msg = email_msg[0]
            if (!email_msg.innerText){
