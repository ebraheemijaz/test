...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">Add Advert</header>
                    <div class="panel-body">
                        <?= form_open_multipart('admin/insert/advert/advert',array("class"=>"form-signin","autocomplete"=>"off","style"=>"max-width: 100% !important;")) ?>
                        <div class="login-wrap">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div><small style="text-align: center;">Desktop</small></div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <small style="text-align: center;">Tablet</small>
                                </div>
                            </div>
                            <div class="col-md-2" style="margin-bottom: 20px;">
                                <div>
                                    ...
                                    <small style="text-align: center;">Mobile</small>
                                </div>
                            </div>
                            <div class="row"></div>
                            <div class="col-md-2">
