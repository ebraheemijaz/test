        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="breadcrumb">
                    ...
                    <li><a href="">Send Email To Church Group</a></li>
                </ul>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">Send Email To Church Group</header>
                    <div class="panel-body">
                        ...
                        <?php if(!empty($msg)){ ?>
                            ...
                            <br/>
                        <?php } ?>
                        <p style="display: none;" id="memCountp"><span id="memCount"></span> Members will receive the emails</p>
                        <?= form_open_multipart('admin/sendEmail/church',array("class"=>"form-horizontal")) ?>
...
<script>
    ...
    $("[name=to]").change(function(){
        ...
        $.post("<?= site_url('admin/ajax/getSMSchurchCount'); ?>",{id:a},function(e){
            $("#memCount").html(e);
        });
    });
</script>