<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">Edit Offerings</header>
                    <div class="panel-body">
                        <?= form_open('admin/update/'.$data[0]['id'].'/offerings/view_offerings',array("class"=>"form-horizontal")) ?>
