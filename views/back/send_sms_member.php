<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">Send SMS</header>
                    <div class="panel-body">
                        ...
                        <?= form_open('admin/sendSMS/member',array("class"=>"form-horizontal", "id" => "my-form")) ?>
                            <?php
                                $members = $this->data->myquery("SELECT * FROM `member` WHERE `first_time` = 'no' ORDER BY lname ASC");
                            ?>
                                ...
                                <div class="col-md-10 member">
                                    <select name="member[]" required="true" multiple class="form-control chosen-select" id="mem">
                                        ...
                                        <?php foreach($members as $val){ ?>
                                            <option value="<?= $val['id'] ?>"><?= $val['lname'] ?> <?= $val['fname'] ?></option>
                                        <?php } ?>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <p>
                                        <span id="remaining">0 characters remaining</span>
                                        <span id="messages">0 message(s)</span>
                                    </p>
                            ...
                            <div class="form-group">
                                <div class="col-md-10 col-md-offset-2 " >
                                    <button class="btn btn-success" disabled id="send_sms_button">Send</button>
                                </div>
                            </div>
                        </form>
                    </div>
